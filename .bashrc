...
# how we bettercap
alias bcap="sudo bettercap --iface wlp2s0 -eval 'wifi.recon on; set wifi.show.sort clients desc; set ticker.commands clear; wifi.show; set ticker.period 7; set wifi.handshakes.file /home/think/better.pcap;'"

# 

# use rust package `ouch` for de/compression 
